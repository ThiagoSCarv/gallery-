...
export const inputSingleFileVariants = tv({
	base: `flex flex-col items-center justify-center w-full border border-solid border-border-primary group-hover:border-border-active gap-1 transition rounded-lg`,
	variants: {
		size: {
			md: "px-5 py-6",
		},
